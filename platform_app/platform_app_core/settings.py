...
SECRET_KEY = 'django-insecure-0b0ya8ny8xl+savt%x)wi+3fqhnd%0jw1dh+6p070-^&@nqgw9'
...
ROOT_URLCONF = 'platform_app_core.urls'
...
WSGI_APPLICATION = 'platform_app_core.wsgi.application'
...
# OR for more security, explicitly allow only your frontend:
